    ...
    Route::middleware(['role:Production'])->group(function () {
        Route::prefix('consumable-issuance')
            ...
            Route::middleware(['operational.hours'])->group(function () {
                    ...
                    Route::delete('/remove-item/{detailId}', [ConsumableIssuanceController::class, 'removeItem'])->name('removeItem');
                    Route::post('/{id}/submit',              [ConsumableIssuanceController::class, 'submit'])->name('submit');
                });
            });

        Route::prefix('material-issuance')
