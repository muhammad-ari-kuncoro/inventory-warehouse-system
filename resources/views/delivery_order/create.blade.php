...
@push('styles')
<style>
    #div_material, #div_consumable, #div_tool { display: none; }
</style>
@endpush
                    ...
                    <div class="col-lg-6">
                        <div class="border rounded p-4 h-100">
                            ...
                            <form action="{{ route('delivery-order.store') }}" method="post" id="formSubmit">
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Address Recipient <span class="text-danger">*</span></label>
                                    <textarea class="form-control @error('penerima') is-invalid @enderror"
                                        name="penerima" rows="3" placeholder="Please insert this field after you add the item unit ..."></textarea>
                                    @error('penerima')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Name Project <span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-6">
                        <div class="border rounded p-4 h-100">
                            ...
                            <form action="{{ route('delivery-order.store.item') }}" method="post">
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Description Item Unit <span class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Item / Unit Size <span class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Type Quantity<span class="text-danger">*</span></label>
