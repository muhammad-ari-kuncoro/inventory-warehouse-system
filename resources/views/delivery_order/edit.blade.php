                ...
                <div class="col-lg-6">
                    <form action="{{ route('delivery-order.update', $do->id) }}" method="post" id="formSubmit">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control rounded-top @error('tanggal_pengiriman') is-invalid @enderror" type="date" value="{{ $do->do_date }}" name="tanggal_pengiriman" placeholder="Harap Di Isi Tanggal Pengiriman Barang">
