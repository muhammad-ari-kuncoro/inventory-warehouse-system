...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body">
        <h5 class="card-title mb-4">Detail Material Information</h5>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="p-3 bg-light rounded">
                    ...
                    <p class="fw-semibold mb-0 mt-1">{{ $find_id->nama_material ?? '-' }}</p>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="p-3 bg-light rounded">
                    ...
                    <p class="fw-semibold mb-0 mt-1">{{ $find_id->spesifikasi_material ?? '-' }}</p>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="p-3 bg-light rounded">
                    <small class="text-muted">Type Quantity</small>
            ...
            <div class="col-md-6">
                <div class="p-3 bg-light rounded">
                    <small class="text-muted">Type Material</small>
                    <p class="fw-semibold mb-0 mt-1">
                        <span class="badge bg-primary">{{ $find_id->jenis_material ?? '-' }}</span>
                    </p>
                </div>
            </div>
    ...
    <div class="p-3 bg-light rounded">
        ...
        <p class="fw-semibold mb-0 mt-1" id="materialPrice">
            {{ $find_id->harga_material ?? 0 }}
        </p>
    </div>
</div>
            <div class="col-md-6">
        ...
        <div class="d-flex gap-2 mt-4">
            ...
            <a href="{{ route('material.edit', $find_id->id) }}" class="btn btn-warning">Edit</a>
        </div>
