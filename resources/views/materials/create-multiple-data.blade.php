            ...
            <form id="materialForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_material') is-invalid @enderror"
                        name="nama_material" id="nama_material" placeholder="Please fill in the material name field ..."
                        required>
                    @error('nama_material')
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('jenis_material') is-invalid @enderror" name="jenis_material"
                        id="jenis_material" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="harga_material" id="harga_material" placeholder="0"
