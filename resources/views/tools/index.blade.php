...
<div class="card">
    <h5 class="card-header text-center">
        Dashboard Menu Peralatan Dan Permesinan
    </h5>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="nama_tool" class="form-label">Nama Alat Atau Mesin </label>
                        <input class="form-control rounded-top  @error('nama_tools') is-invalid @enderror" type="text" name="nama_tools"
                            placeholder="Harap Di Isi Tools Peralatan Atau Permesinan" required>
                            @error('nama_tools')
                    ...
                    <div class="mb-3">
                        <label for="spesifikasi_tool" class="form-label">Spesifikasi Alat Atau Mesin </label>
                        <input class="form-control rounded-top @error('spesifikasi_tool') is-invalid @enderror" type="text" name="spesifikasi_tool"
                            placeholder="Harap Di Isi Spesifikasi Peralatan Atau Permesinan" required>
                            @error('spesifikasi_tool')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select rounded-top @error('jenis_alat') is-invalid @enderror" name="jenis_alat" required>
                    ...
                    <div class="mb-3">
                        <label for="tipe_alat" class="form-label" name="tipe_alat">Jenis Alat </label>
                        <select class="form-select rounded-top @error('tipe_alat') is-invalid @enderror" name="tipe_alat" required>
                            <option selected disabled>Pilih Jenis Alat</option>
                    ...
                    <div class="mb-3">
                        <label for="quantity" class="form-label">Spesifikasi Alat Atau Mesin </label>
                    ...
                    <div class="mb-3">
                        <label for="jenis_quantity" class="form-label" name="jenis_quantity">Jenis Alat</label>
