<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    @if (auth()->user()->role == 'Administrator' || auth()->user()->role == 'Warehouse Staff')
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ in_array($sub_title, ['Main Project', 'Sub Project']) ? 'active open' : '' }}">
            ...
            <li class="menu-item {{ in_array($sub_title, ['Tools', 'Machine']) ? 'active open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <li class="menu-item {{ in_array($sub_title, ['Good Received', 'Delivery Order', 'Subcon Out']) ? 'active open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
