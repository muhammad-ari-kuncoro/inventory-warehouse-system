        ...
        <div class="card mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control rounded-top @error('bagian_divisi') is-invalid @enderror " type="text" name="bagian_divisi"
                    placeholder="Harap Di Isi Spesifikasi Material" value="{{ old('bagian_divisi', $find_id->bagian_divisi)}}" disabled>
                    @error('bagian_divisi')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control rounded-top @error('nama_pengambil') is-invalid @enderror " type="text" name="nama_pengambil"
                    placeholder="Harap Di Isi Spesifikasi Material" value="{{ old('nama_pengambil', $find_id->nama_pengambil)}}" disabled>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="bagian_divisi" class="form-label">Nama Material </label>
                    <input class="form-control rounded-top @error('nama_pengambil') is-invalid @enderror " type="text" name="nama_pengambil"
                        placeholder="Harap Di Isi Spesifikasi Material" value="{{ old('nama_material', $find_id->material->nama_material)}}" disabled>
                        @error('nama_pengambil')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    <label for="bagian_divisi" class="form-label">Spesifikasi Material </label>
                    <input class="form-control rounded-top @error('nama_pengambil') is-invalid @enderror " type="text" name="nama_pengambil"
                        placeholder="Harap Di Isi Spesifikasi Material" value="{{ old('spesifikasi_consumable', $find_id->material->spesifikasi_material)}}" disabled>
                        @error('nama_pengambil')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control rounded-top @error('quantity') is-invalid @enderror " type="text" name="quantity"
                        placeholder="Harap Di Isi Spesifikasi Material" value="{{ old('quantity', $find_id->quantity)}}" disabled>
                        @error('quantity')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control rounded-top @error('jenis_quantity') is-invalid @enderror " type="text" name="jenis_quantity"
                        placeholder="Harap Di Isi Spesifikasi Material" value="{{ old('jenis_quantity', $find_id->jenis_quantity)}}" disabled>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control rounded-top @error('project_id') is-invalid @enderror " type="text" name="project_id"
                        placeholder="Harap Di Isi Spesifikasi Material" value="{{ old('nama_project', $find_id->project->nama_project)}}" disabled>
                        @error('project_id')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control rounded-top @error('project_id') is-invalid @enderror " type="text" name="project_id"
                        placeholder="Harap Di Isi Spesifikasi Material" value="{{ old('sub_nama_project', $find_id->project->sub_nama_project)}}" disabled>
                        @error('project_id')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3 text-center">
                    <a href="{{ route('material-issuance.index') }}" class="btn btn-secondary">Go Back</a>
